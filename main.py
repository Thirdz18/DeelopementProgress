...
def turnkey_email_otp_verify():
    ...
    try:
        ...
        otp_id = session.get('_email_otp_id', '')
        ...
        from turnkey_service import verify_email_otp, create_sub_org_for_email
        verify_email_otp(otp_id, otp_code)

        session.pop('_email_otp_id', None)
